                                        ...
                                        <table>
                                          ...
                                          {headers.map((header, index) => (
                                            ...
                                            <tr>
                                              ...
                                              <th rowspan="2">Visual Of Coated Pipe</th>
                                              <th rowspan="2">Coating Status</th>
                                              <th rowspan="2">Test On Pipe</th>
                                              <th rowspan="2">Remarks(Quenching temp °C)</th>
                                            </tr>
                                            <tr>
                                          ...
                                          <tbody>
                                            {chunk?.map((row, rowIndex) => {
                                              ...
                                              // console.log(row['Coating Status'], "rows")

                                              const isHCTrail = headers?.some(cell => (row[cell] === 'H/C Trial' || row[cell] === 'Bare' || row[cell] === 'FBE' || row[cell] === 'H/C'));
                                              return (
                                                <tr key={rowIndex}>
                                                  ...
                                                  {headers?.map((cell, cellIndex) => {
                                                    ...
                                                    return (
                                                      < td key={cellIndex} > {isHCTrail && !isSpecialColumn ? "-" : (row[cell] == "NA" ? "-" : row[cell] !== null && row[cell] !== undefined && row[cell] !== 0 && row[cell] !== "Select" ? row[cell] : "-")}</td>
                                                    )
