...
function PhosBlastInsp() {
    ...
    const chunkedData = chunkAndPadArray(randomWitnessList, 15);
        ...
        <>
          ...
          @media print {
            .CustomBarePipeWitnessBox2 {
              height: ${witnessHeight - 48}px !important;
            }
          }
        `}
            </style>
                                                                                    ...
                                                                                    <table>
                                                                                        <thead>
                                                                                            <tr>
                                                                                                ...
                                                                                                <th rowSpan={2}>Pipe Temp. Before Blasting<br />(°C)</th>
                                                                                                <th rowSpan={2}>Pipe Temp. Before Acid Wash<br />(°C)</th>
                                                                                                ...
                                                                                                <th colSpan={4}>DM Water Flow Rate(LPM)</th>
                                                                                                <th rowSpan={2}>Preheating Temp. of Air <br /> After water Wash (°C)</th>
                                                                                                <th rowSpan={2}>RH (%)</th>
                                                                                                <th rowSpan={2}>Amb. Temp. (°C)</th>
                                                                                                <th rowSpan={2}>Dew Point <br />(°C)</th>
                                                                                                ...
                                                                                                {/* {pm_Approve_level1 == "second" && regPerc != 100 ? <th rowSpan={2}>{checkedCount}/{testDetails.length} Data Verified (Select atleast : {Math.ceil((regPerc / 100) * testDetails.length)})</th> : ''} */}
                                                                                                {/* <th rowSpan={2}></th> */}
                                                                                            </tr>
                                                                                            <tr>
                                                                        ...
                                                                        <div className='col-md-12 col-sm-12 col-xs-12 p-0'>
                                                                            <table>
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>Anchor Pattern Under 30X Magnification has been checked on above pipes & found no dished or round profile as per appoved QAP </td>
                                                                                    </tr>
                                                                                    {/* : ''} */}
                                                                                    <tr>
                                                                                    ...
                                                                                    <thead>
                                                                                        ...
                                                                                        <tr>
                                                                                            {instrumentDetails?.map((data) => {
                                                                                                return (
                                                                                                    <>
                                                                                                        <td style={{ fontWeight: 'bold' }}>INSTRUMENT NAME</td>
                                                                                                        <td>INSTRUMENT ID</td>
                                                                                                    </>
                                                                                                )
                                                                                            })}
