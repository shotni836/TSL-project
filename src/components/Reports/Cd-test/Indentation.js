                                                        ...
                                                        <form className='row'>
                                                            ...
                                                            <div className='col-md-5 col-sm-6 col-xs-12'>
                                                                <div className='form-group'>
                                                                    ...
                                                                    <span>: &nbsp;</span>
                                                                    <h4>{headerDetails.procSheetNo || "-"} Rev. - DATE: {headerDetails?.formatdate && convertDate(headerDetails?.formatdate)}</h4>
                                                                </div>
                                                            </div>
                                                            <div className='col-md-7 col-sm-6 col-xs-12'>
                                                                <div className='form-group'>
                                                                    ...
                                                                    <div id='custom-scroll'>
                                                                        <table>
                                                                            <thead>
                                                                                ...
                                                                                <tr>
                                                                                    {console.log("first", testDetails[2])}
                                                                                    {testDetails[0].pm_test_id == '293' && <th colSpan={3}>Temp. :- {testDetails[0].pm_reqmnt_temperature}±{testDetails[0].pm_reqmnt_temp_Minus} {testDetails[0].unit}</th>}
                                                                                    {testDetails[2].pm_test_id == '986' && <th colSpan={3}>Temp. :- {testDetails[2].pm_reqmnt_temperature}±{testDetails[2].pm_reqmnt_temp_Minus} {testDetails[2].unit}</th>}
                                                                                </tr>
                                                                                <tr>
                                                                                        ...
                                                                                        return (
                                                                                            <React.Fragment key={rowIndex}>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>{parseFloat(item.pm_initial_val_normal).toFixed(2) || "-"}</td>
                                                                                                    <td>{parseFloat(item.pm_final_val_normal).toFixed(2) || "-"}</td>
                                                                                                    <td>{parseFloat(item.pm_result_normal).toFixed(2) || "-"}</td>
                                                                                                    <td>{parseFloat(item.pm_initial_val_hot).toFixed(2) || "-"}</td>
                                                                                                    <td>{parseFloat(item.pm_final_val_hot).toFixed(2) || "-"}</td>
                                                                                                    <td>{parseFloat(item.pm_result_hot).toFixed(2) || "-"}</td>
