...
function PorosityTest() {
        ...
        const fetchData = async () => {
            try {
                if (tstmaterialid) {
                    ...
                    const hwiId = ['285', '295'];
                    const instIdToSend = hwiId.includes(id4) ? 285 : id4;
                    const response1 = await axios.get(`${Environment.BaseAPIURL}/api/User/GETInstrumentDetailsByReportId?ReportId=${instIdToSend}`);
    ...
    // 285,295-3 :: 251,305,306-6 :: 287-5 :: 283-4
    const noOfRow = id4 === '251' || id4 === '305' || id4 === '306' ? 6 : id4 === '285' || id4 === '295' ? 3 : id4 === '287' ? 5 : 4;
                                                            ...
                                                            <form className='row'>
                                                                ...
                                                                <div className='col-md-5 col-sm-6 col-xs-12'>
                                                                    <div className='form-group'>
                                                                        ...
                                                                        <span>: &nbsp;</span>
                                                                        <h4>LTR/{headerDetails?.reportAlias}/{reportTestDate} - 01</h4>
                                                                    </div>
                                                                </div>
                                                                <div className='col-md-7 col-sm-6 col-xs-12'>
                                                                    <div className='form-group'>
                                                                            ...
                                                                            <table>
                                                                                ...
                                                                                <tbody>
                                                                                    {chunk?.map((item, index) => {
                                                                                        return (
                                                                                            <tr key={index} style={{ height: id4 === '305' ? '10px' : '33.67px' }}>
                                                                                                {id4 === '287' ? (
                                                                                                    rowSpans[index] > 0 && (
                                                                                                ...
                                                                                                {rowSpans[index] > 0 && (
                                                                                                    id4 === '285' || id4 === '295' || id4 === '287' || id4 === '305' || id4 === '283' ? <td rowSpan={rowSpans[index]}>
                                                                                                ...
                                                                                                {id4 == 283 ?
                                                                                                    <td >
                                                                                                        <div style={{ height: '15px' }}>ΔTg ≤ {item.pm_reqmnt_temperature || "-"} °C</div><hr />
                                                                                                        <div style={{ height: '15px' }}>CURE = Min. {item.pM_Reqmnt_test_min || "-"} %</div>
                                                                                                    </td>
                                                                                                    : (rowSpans[index] > 0 && (
                                                                                                        <td rowSpan={rowSpans[index]}>
                                                                                                ...
                                                                                                {id4 === '285' || id4 === '295' || id4 === '287' ? <td>{item.pm_test_result_remarks || '-'}</td>
                                                                                                    : id4 == 283 ?
                                                                                                        <td >
                                                                                                            <div style={{ height: '15px' }}>ΔTg = {item.pm_test_result_remarks.split('~')[0] || "-"}</div> <hr />
                                                                                                            <div style={{ height: '15px' }}>%CURE = {item.pm_test_result_remarks.split('~')[1] || "-"}</div>
                                                                                                        </td>
