...
function Tallytagmapping() {
    ...
    const handleDrop = (files) => {
        ...
        if (file && (file.name.endsWith('.xlsx') || file.name.endsWith('.xls'))) {
            ...
            reader.onload = (e) => {
                ...
                setTotalPipeNumberCount(totalPipeNumbers);
                console.log('Total Pipe number:', totalPipeNumbers);
    ...
    const validateTallysheet = async () => {
        ...
        try {
            ...
            console.log(response.data.length, 303)
                                        ...
                                        <div className='PipeTallySheetDetails'>
                                            <form className='row m-0'>
                                                ...
                                                {[
                                                    ...
                                                    { id: 'specification', label: 'Specification', value: headerData?.specgrade != undefined ? headerData?.specgrade : '' },
