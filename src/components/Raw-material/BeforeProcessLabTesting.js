                                            ...
                                            <form action="" className='row m-0'>
                                                ...
                                                {disable && (
                                                    <>
                                                        ...
                                                        {groupedDataArray.length !== 0 && beforeLabSelectData !== '248' && <>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tbody>
                                                                        {groupedDataArray.filter(item => {
                                                                            if (beforeLabSelectData === '243') {
                                                                                return ["Phosphoric Acid"].includes(item.Material);
                                                                            }
                                                                            if (beforeLabSelectData === '261') {
                                                                                return ["Chromate"].includes(item.Material);
                                                                            }
                                                                            if (beforeLabSelectData === '208') {
                                                                                return ["Shot"].includes(item.Material);
                                                                            }
                                                                            if (beforeLabSelectData === '215') {
                                                                                return ["Grit"].includes(item.Material);
                                                                            }
                                                                            if (beforeLabSelectData === '242' || beforeLabSelectData === '650') {
