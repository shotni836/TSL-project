...
function Rawmaterial() {
    ...
    const fetchEditDetails = async () => {
        ...
        const hwiId = ['285', '295'];
        const instIdToSend = cdId.includes(TestId) ? 297 : hwiId.includes(TestId) ? 285 : TestId;
    ...
    const initializeResultSuffixInput = (response) => {
        ...
        TestId == '283' ? (setResultInput(resultInputTemp) &&
            setResultInput1(resultInput1Temp)) : setResultInput(updatedResultInput);
    ...
    const handleSubmit = async (e, value) => {
        ...
        const dataToSend = {
            ...
            testdate: (selectedTestId == '293' || selectedTestId == '986' || TestId == '293' || TestId == '986' || selectedTestId == '325') ? new Date().toLocaleString("sv-SE").split(" ").join("T") : dateTimes ? new Date(dateTimes).toLocaleString("sv-SE").split(" ").join("T") : formData.testdate,
                                            ...
                                            <form action="" className='row m-0'>
                                                ...
                                                {disable && (
                                                    <>
                                                        ...
                                                        {isRawMaterial.length && selectedTestId == '297' || selectedTestId == '298' || selectedTestId == '299' || selectedTestId == '300' || selectedTestId == '301' || selectedTestId == '302' || TestId == '297' || TestId == '298' || TestId == '299' || TestId == '300' || TestId == '301' || TestId == '302' && groupedDataArray.some(item =>
                                                                                ...
                                                                                <Table id='subtesttbl'>
                                                                                    <thead>
                                                                                        <tr style={{ background: '#5a245a', color: '#fff' }}>
                                                                                            ...
                                                                                            <th style={{ minWidth: '70px' }}>Sample Cut Required</th>
                                                                                            <th style={{ minWidth: '100px' }}>Sample Cut Size</th>
                                                                                            <th style={{ minWidth: '150px' }}>ΔTg</th>
                                                                                            <th style={{ minWidth: '160px' }}>Result</th>
                                                                                            <th style={{ minWidth: '150px' }}>CURE </th>
                                                                                            <th style={{ minWidth: '160px' }}>Result</th>
                                                                                                    ...
                                                                                                    <tr key={key}>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                                                                                                ...
                                                                                                                />
                                                                                                                {selectedTestId == '304' || selectedTestId == '287' || selectedTestId == '285' || selectedTestId == '295' ? '' : <div style={{ marginLeft: '5px' }}>{" " + item.Unit}</div>}
                                                                                                            </div>
                                                                                            ...
                                                                                            Array.from({ length: numRows }).map((_, rowIndex) => {
                                                                                                ...
                                                                                                return (
                                                                                                    <tr key={key}>
                                                                                                        ...
                                                                                                        {/* {console.log("1950", resultInput3[key])} */}
                                                                                                        {selectedTestId == '304' || TestId == '304' || selectedTestId == '284' || TestId == '284' ?
                                                                                                            <td>
                                                                                                                <input
                                                                                                                    type='text'
