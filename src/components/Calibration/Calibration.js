  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const updatedFormData = {
        ...
        report_format: selectedReportFormat.map(proc => proc.value).join(','),//(selectedReportFormat.value).toString(),
                        ...
                        <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                          <div className="accordion-body row m-0">
                            ...
                            <div className='form-group col-md-4 col-sm-4 col-xs-12'>
                              ...
                              <input style={{ pointerEvents: 'none', background: "#f3f3f3" }} type="text" value={new Date(nextCalibrationDate).toLocaleDateString("en-GB").replace(/\//g, "-").split(" ")[0]} />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                          <div className="accordion-body row m-0">
                            ...
                            <div className="form-group col-md-4 col-sm-4 col-xs-12">
                              ...
                              <input type="text" placeholder="Asset No." name="pm_calib_asset_no" value={assetNo}
                              //  onChange={handleAssetNoChange} value={formData.pm_calib_asset_no} onChange={handleChange}
                              />
                            </div>
                            <div className='form-group col-md-4 col-sm-4 col-xs-12'>
                            ...
                            <div className="form-group col-md-12 col-sm-12 col-xs-12">
                              ...
                              <label className="NABLCheckbox" htmlFor="pm_isACM">
                                <input type="checkbox" id="pm_isACM" name="pm_isACM" value="pm_isACM" checked={formData.pm_isACM} onChange={handleChange} /> AMC
                              </label>
                            </div>
