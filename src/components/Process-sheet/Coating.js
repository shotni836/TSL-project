...
const Coating = () => {
      ...
      .then((response) => {
        if (response?.data) {
          ...
          if (response?.data[4]) {
            ...
            console.log(formData, mappedTestData)
  ...
  const handleDdlChange = (data) => {
    ...
    if (data == "tslclientID") {
      ...
      console.log(ddltslId.current, 389)
    }
    if (data == "tpiclientID") {
  ...
  const handleChange = (e, index, fieldname, testdesc_id) => {
    ...
    if (
      ...
      if (TableTestGridRowData?.length > 0) {
        ...
        if (eleindex != undefined) {
          if (e === null) {
            ...
            if (fieldname === "chkchecked") {
              ...
              console.log(TableTestGridRowData[eleindex][fieldname], e.target.checked)
            } else {
              ...
              if (fieldname == 'min') {
                ...
                TableTestGridRowData[eleindex][fieldname] =
                  e.value === undefined ? e.target.value : e.value;
                console.log(TableTestGridRowData[eleindex][fieldname], TableTestGridRowData[eleindex]["max"], e.value)
              }
        ...
        console.log(tslclientID, "2");
        // console.log(secureLocalStorage.getItem("tslclientID"), "2")
        let objtestsData = {
          index: index,
          chkchecked: "false",
          co_param_val_id: "",
      ...
      console.log(TableTestGridRowData[TableTestGridRowData.length - 1])
      if (fieldname == "suffix") {
      ...
      console.log(TableTestGridRowData, '12121212')
  ...
  const handleSubmit = async (e, value) => {
    ...
    if (TestGridRowData.length > 0) {
      ...
      console.log(TestGridRowData.length)
    ...
    console.log(isProcessSheetCopy, proc_type, '----completeformdata')
  ...
  useEffect(() => {
    ...
    console.log(ddltslId.current, 'useffect')
  }, [ddltslId.current])
                    ...
                    {ShowProcessTypeGrids && (
                      <>
                        ...
                        <div className="FlexSubmitFlex">
                          <button type="submit" disabled={handleSubmitDisable} className="DraftSaveBtn subBtn mx-2" onClick={(e) => handleSubmit(e, false)}>Draft Save</button>
                          <button type="submit" disabled={handleSubmitDisable} className="subBtn" onClick={(e) => handleSubmit(e, true)}>Next</button>
                        </div>
                      </>
                    )}
                  </form>
