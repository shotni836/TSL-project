...
function Externaloriginlist() {
  ...
  const handleListClick = () => {
    window.open('/externaloriginedit', '_blank');
  };
  ...
  const actionCellRenderer = (params) => (
    <div className="action-icons">
      ...
      <i className="fa-solid fa-edit" onClick={handleListClick} style={{ color: "#4caf50", margin: '4', paddingRight: "10px", cursor: "pointer" }}></i>
