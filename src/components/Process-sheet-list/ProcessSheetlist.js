...
function ProcessSheetlist() {
  ...
  const handleViewClick = (rowData) => {
    navigate(`/processsheetview?id=${rowData.project_id}&ViewType=View&menuId=${menuId}&Proc_type=${rowData.Proc_Type}`);
  };
  ...
  const onhandleAddStationClick = (rowData) => {
    navigate(`/addstation?menuId=${menuId}&id=${rowData.project_id}&proc_type=${rowData.Proc_Type}&coatingType=${rowData.Coatingtype}&processSheet=${rowData.ProcSheetNo}&client=${rowData.Client}&LOIPOFOA=${rowData["LOI/PO/FOA No"]}&coatingDate=${rowData.ProcSheetDate}`);
  };
