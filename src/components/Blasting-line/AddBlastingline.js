                      ...
                      {visible &&
                        <>
                          ...
                          <div className="col-md-12 col-sm-12 col-xs-12 mt-4">
                            <button type="submit" className="SubmitNextbtn" onClick={(e) => handleSubmit(e, false)}>Draft Save</button>
                            <button type="submit" className="SubmitNextbtn" style={{ float: "right" }} onClick={(e) => handleSubmit(e, true)}>Submit</button>
                          </div>
                        </>
                      }
                    </form>
